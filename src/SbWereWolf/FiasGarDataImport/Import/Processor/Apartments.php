...
use PDO;
use SbWereWolf\FiasGarDataImport\Import\Composition\Column\ApartamentTypeColumn;
...
class Apartments extends Importer
{
    private const TABLE_NAME = 'APARTMENTS';
    private int $id = -1;
    private int $objectId = -1;
    private string $objectGuid = '';
    private string $number = '';
    private int $apartType = -1;
    ...
    public function __construct(PDO $connection)
    {
        $columns = [
            ...
            ApartamentTypeColumn::class => &$this->apartType,
