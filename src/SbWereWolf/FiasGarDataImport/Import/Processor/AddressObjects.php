...
use SbWereWolf\FiasGarDataImport\Import\Composition\Column\LevelDataColumn;
...
use SbWereWolf\FiasGarDataImport\Import\Composition\Column\TypeNameColumn;
...
class AddressObjects extends Importer
{
    private const TABLE_NAME = 'ADDRESSOBJECTS';
    private int $id = -1;
    ...
    public function __construct(PDO $connection)
    {
        $columns = [
            ...
            TypeNameColumn::class => &$this->typeName,
            LevelDataColumn::class => &$this->level,
